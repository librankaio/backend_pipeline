                ...
                a = function(t, e) {
                    ...
                    h.prototype = {
                        ...
                        update: function() {
                            ...
                            a = !0) : (i = (i = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val()) && this.o.multidate ? i.split(this.o.multidateSeparator) : [i],
                            ...
                            a ? (this.setValue(),
                            this.element.change()) : this.dates.length && String(e) !== String(this.dates) && a && (this._trigger("changeDate"),
                            this.element.change()),
                        ...
                        fill: function() {
                            var s, n, o = new Date(this.viewDate), r = o.getUTCFullYear(), h = o.getUTCMonth(), l = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, d = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, c = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, u = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, p = f[this.o.language].today || f.en.today || "", y = f[this.o.language].clear || f.en.clear || "", m = f[this.o.language].titleFormat || f.en.titleFormat, D = a(), v = (!0 === this.o.todayBtn || "linked" === this.o.todayBtn) && D >= this.o.startDate && D <= this.o.endDate && !this.weekOfDateIsDisabled(D);
                            if (!isNaN(r) && !isNaN(h)) {
                                ...
                                for (var _, C, T = []; w.valueOf() < b; ) {
                                    if ((_ = w.getUTCDay()) === this.o.weekStart && (T.push("<tr>"),
                        ...
                        click: function(e) {
                            ...
                            1,
                            1 === this.viewMode ? (o = s.parent().find("span").index(s),
                            n = this.viewDate.getUTCFullYear(),
                            this.viewDate.setUTCMonth(o)) : (o = 0,
                            n = Number(s.text()),
                            this.viewDate.setUTCFullYear(n)),
                            this._trigger(g.viewModes[this.viewMode - 1].e, this.viewDate),
                            this.viewMode === this.o.minViewMode ? this._setDate(i(n, o, 1)) : (this.setViewMode(this.viewMode - 1),
                            this.fill())),
                    ...
                    var f = t.fn.datepicker.dates = {
                      ...
                      , g = {
                        ...
                        parseDate: function(i, s, n, o) {
                            ...
                            var m, D, v = {}, w = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], k = {
                                yyyy: function(t, e) {
                                    return t.setUTCFullYear(o ? (!0 === (a = o) && (a = 10),
                            ...
                            r.length === b.length) {
                                ...
                                for (c = 0; c < w.length; c++)
                                    (M = w[c])in v && !isNaN(v[M]) && (T = new Date(i),
                                    k[M](T, v[M]),
                                    isNaN(T) || (i = T))
                            }
                            return i
