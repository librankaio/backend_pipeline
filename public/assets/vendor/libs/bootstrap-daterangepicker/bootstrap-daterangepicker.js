...
!function(t, e) {
    ...
    return function() {
                    ...
                    function(t, e) {
                        var a = function(a, i, s) {
                            ...
                            if (void 0 === i.startDate && void 0 === i.endDate && e(this.element).is(":text")) {
                                ...
                                l = t(d[1], this.locale.format)) : this.singleDatePicker && "" !== c && (o = t(c, this.locale.format),
                                l = t(c, this.locale.format)),
                                null !== o && null !== l && (this.setStartDate(o),
                                this.setEndDate(l))
                            }
                            if ("object" == typeof i.ranges) {
                                for (h in i.ranges) {
                                    ...
                                    this.minDate && l.isBefore(this.minDate, this.timepicker ? "minute" : "day") || p && o.isAfter(p, this.timepicker ? "minute" : "day") || ((m = document.createElement("textarea")).innerHTML = h,
                                    n = m.value,
                                    this.ranges[n] = [o, l])
                                }
                                var f = "<ul>";
                        ...
                        return a.prototype = {
                            ...
                            updateCalendars: function() {
                                ...
                                this.timePicker24Hour || ("PM" === (i = this.container.find(".left .ampmselect").val()) && t < 12 && (t += 12),
                                "AM" === i && 12 === t && (t = 0))) : (t = parseInt(this.container.find(".right .hourselect").val(), 10),
                            ...
                            renderCalendar: function(a) {
                                var i, s = (i = "left" == a ? this.leftCalendar : this.rightCalendar).month.month(), n = i.month.year(), r = i.month.hour(), o = i.month.minute(), l = i.month.second(), h = t([n, s]).daysInMonth(), c = t([n, s, 1]), d = t([n, s, h]), m = t(c).subtract(1, "month").month(), p = t(c).subtract(1, "month").year(), f = t([p, m]).daysInMonth(), u = c.day();
                                (i = []).firstDay = c,
                                i.lastDay = d;
                                for (var D = 0; D < 6; D++)
                                    i[D] = [];
                                ...
                                for (var y = t([p, m, g, 12, o, l]), k = (D = 0,
                                0), b = 0; D < 42; D++,
                                k++,
                                y = t(y).add(24, "hour"))
                                    D > 0 && k % 7 == 0 && (k = 0,
                            ...
                            renderTimePicker: function(t) {
                                if ("right" != t || this.endDate) {
                                    ...
                                    h = 0; h < 60; h += this.timePickerIncrement) {
                                        var p = h < 10 ? "0" + h : h;
                                        d = a.clone().minute(h),
                                        m = !1,
                                ...
                                if (e(t.target).hasClass("available")) {
                                    ...
                                    if (this.endDate || n.isBefore(this.startDate, "day")) {
                                        if (this.timePicker) {
                                            ...
                                            this.timePicker24Hour || ("PM" === (h = this.container.find(".left .ampmselect").val()) && r < 12 && (r += 12),
                                            "AM" === h && 12 === r && (r = 0));
                                        ...
                                        var h;
                                        this.timePicker && (r = parseInt(this.container.find(".right .hourselect").val(), 10),
                                        this.timePicker24Hour || ("PM" === (h = this.container.find(".right .ampmselect").val()) && r < 12 && (r += 12),
                                        "AM" === h && 12 === r && (r = 0)),
        ...
        function s(t) {
            ...
            return a[t].call(n.exports, n, n.exports, s),
            n.exports
        }
        s.n = function(t) {
        ...
        return function() {
            ...
            $.fn.daterangepicker = function(e, a) {
                ...
                e && (e.showWeekNumbers || e.showISOWeekNumbers) && this.each((function() {
